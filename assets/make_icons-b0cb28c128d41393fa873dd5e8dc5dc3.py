            ...
            for t in range(8):
                with open(template_files[t], 'r') as template_file:
                    ...
                    for i in range(3):
                        ...
                        svg2png(bytestring=svg_str,write_to=f"icons/icon{s}{t}{i}{c}.png", output_width=size)
